...
export function TopNav() {
    ...
    return (
        <>
            <div id="TopNav" className="fixed bg-blue z-30 flex items-center w-full border-b h-[60px] ">
                <div className={`flex items-center justify-between gap-6 w-full px-4 mx-auto
                        ${pathname == '/' ? 'max-w-[1150px]' : ''}`}>
                    <Link href="/">
                        <img className="min-w-[40px] w-[40px]" src="https://placehold.co/40" />
                    </Link>
                            ...
                            <div className="p-1">
                                ...
                                >
                                    <div className="flex items-center">
                                        ...
                                        <div className="truncate ml-2">John Week Dev</div>
                                    </div>
                                </Link>
                            </div>
                        </div>
                        ...
                        {true ? (
                            ...
                            <div className="flex items-center">
                                <div className="relative">
                                    ...
                                    <div className="absolute bg-white rounded-lg py-1.5 w-[200px] border top-[40px] right-0">
